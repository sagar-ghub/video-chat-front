...
export default function Notification() {
  const { answerCall, call, callAccepted, setCallAccepted } =
    ...
    <>
      {call.isRecievedCall && !callAccepted && (
        ...
        <div
          ...
          class="p-4 sm:static absolute top-60 right-7 w-70 max-w-xs text-gray-500 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-400"
          role="alert"
        >
          <div class="flex">
